...
public class ExceptionDemo {
	...
	/**
	 * Shows what the code looks like if we assume no exceptions or invalid data
	 * will occur. It is more straightforward to understand what this code is
	 * trying to do, and hence easier to debug.
	 *
	 * Note: Avoid suppressing warnings in code. It is done here to demonstrate
	 * bad practice.
	 */
	...
	/**
	 * Handles what can go wrong without catching any exceptions. Instead, we try
	 * to constantly validate the input data. This clutters the code quite a bit,
	 * making it harder to follow. Also, notice we have a problem if we return too
	 * soon without closing the Scanner object.
	 */
	@SuppressWarnings("resource")
	 ...
	 * Scanner removes the necessity of the finally block. We added back in a
